...
class CheckList extends Model
{
    protected $fillable=['applicant_id','mrp_size_photo','passport','citizen','slc_marksheet','slc_character_certificate','slc_certificate',
        ...
        'bachelor_certificate','bachelor_character_certificate','bachelor_transcript','master_certificate','master_character_certificate','master_transcript',
        'internship_completion_certificate','equivalent_certificate','council_registration_certificate_front','council_registration_certificate_back',
        'council_good_standing_letter','work_experience_letter1','work_experience_letter2','work_experience_letter3',
        'work_experience_letter4','work_experience_letter5',
