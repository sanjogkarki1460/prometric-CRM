            ...
            <div class="page-content">
                <div class="page-bar">
                    <div class="page-title-breadcrumb">
                        <div class="pull-left">
                            <div class="page-title">Add Out Going Call Log Update</div>
                        </div>
                        <div class=" pull-right">
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li></i>&nbsp;<a class="parent-item"
                                                 href="{{route('IncomingCallLog.index')}}">Out Going Call Log
                                        View</a>&nbsp;<i
                                            class="fa fa-angle-right"></i>
                                </li>
                                <li class="active">Out Going Call Log Update </li>
                            </ol>
                        </div>
                    </div>
                </div>
                <div class="card">
                    <form action="{{route('OutgoingCallLog.update',$calllog->id)}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input @if($calllog->call_to=='Applicant') checked @endif style="margin-left: 0px;" id="applicant_select" type="radio" name="call_to" value="Applicant" >Applicant
                                    <input @if($calllog->call_to=='Enquiry') checked @endif type="radio" name="call_to" id="enquiry_select" value="Enquiry">Enquiry
                                </div>
                            </div>
                        </div>
