    ...
    <div class="page-container" style="margin-top:-30px;">
        <div class="page-content-wrapper">
            <div class="page-content">
                ...
                <div class="card">
                    <form action="{{route('VisitorLog.update',$visitorlog->id)}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input required class="form form-control"
                                           ...
                                           type="date" name="date" value="{{$visitorlog->date}}">
                                </div>
                            </div>
                        </div>
                        <div class="container">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form form-control"
                                              style="width: 80%;" rows="5"
                                              type="time" name="remarks">{{$visitorlog->remarks}}</textarea>
                                </div>
                            </div>
                        </div>
