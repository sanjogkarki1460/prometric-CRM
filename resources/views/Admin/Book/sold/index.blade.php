                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-topline-aqua">
                            <div class="card-head">
                                <header>Sold Book Detail</header>
                                <div class="cards pull-right">
                                    <a href="{{route('soldbook.create')}}" class="btn btn-success fa fa-plus">Add Sold Book</a>
                                </div>
                            </div>
                            <div class="card-body ">
