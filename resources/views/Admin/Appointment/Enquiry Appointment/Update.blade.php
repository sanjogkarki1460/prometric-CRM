    ...
    <div class="page-container" style="margin-top:-30px;">
        <div class="page-content-wrapper">
            <div class="page-content">
                ...
                <div class="card">
                    <form action="{{route('EnquiryAppointment.update',$appointment->id)}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select required class="form-control form select2" id="enquiry"
                                        ...
                                        @foreach($enquiry as $enquiry)
                                            <option @if($enquiry->first_name==$app) selected
                                                    @endif value="{{$enquiry->id}}">{{$enquiry->first_name}} {{$enquiry->middle_name}} {{$enquiry->last_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
