                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <h5 style="font-size: 20px;" class="control-label text-primary ">MRP Size
                                            Photo</h5>
                                        <input type="checkbox"
                                               @if($checklist->mrp_size_photo=='Yes') checked @endif disabled
                                               name="mrp_size_photo" value="Yes">
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="checkbox"
                                               @if($checklist->slc_character_certificate=='Yes') checked @endif disabled
                                    ...
                                    <div class="col-md-6">
                                        <h5 style="font-size: 20px;" class="control-label text-primary ">
                                            ...
                                            Certificate</h5>
                                        <input type="checkbox"
                                               @if($checklist->equivalent_certificate=='Yes') checked @endif disabled
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="checkbox"
                                               ...
                                               @endif disabled name="council_registration_certificate_back" value="Yes">
                                    </div>
                                    <div class="col-md-6">
                                        <h5 style="font-size: 20px;" class="control-label text-primary ">
                                            Council
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="checkbox"
                                               @if($checklist->work_experience_letter1=='Yes') checked @endif disabled
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="checkbox"
                                               @if($checklist->work_experience_letter2=='Yes') checked @endif disabled
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="checkbox"
                                               @if($checklist->work_experience_letter3=='Yes') checked @endif disabled
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="checkbox"
                                               @if($checklist->signed_service_agreement=='Yes') checked @endif disabled
