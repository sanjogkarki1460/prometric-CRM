                        ...
                        <div class="card card-topline-aqua">
                            <div class="card-head">
                                ...
                                <div class="cards pull-right">
                                    <a href="{{route('Education2.create')}}" class="btn btn-success fa fa-plus">Add
                                        New</a>
                                </div>
                            </div>
                            <div class="card-body ">
                                <div class="table-scrollable">
                                    <table id="example1" class="display" style="width:100%;">
                                        ...
                                        @foreach($education as $education)
                                            <tr>
                                                <td><a href="{{route('ApplicantDetail',$education->applicant_id)}}">{{$education->Applicant_Education2->first_name}} {{$education->Applicant_Education2->middel_name}} {{$education->Applicant_Education2->surname}}</a></td>
                                                ...
                                                @endif
                                                <td class="text-left">
                                                    <form action="{{ route('Education2.edit', $education->id)}}"
                                                          method="GET"
                                                    ...
                                                    <form action="{{ route('Education2.destroy', $education->id)}}"
