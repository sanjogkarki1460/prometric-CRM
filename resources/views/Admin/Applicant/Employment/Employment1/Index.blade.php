                        ...
                        <div class="card card-topline-aqua">
                            <div class="card-head">
                                ...
                                <div class="cards pull-right">
                                    <a href="{{route('Employment.create')}}" class="btn btn-success fa fa-plus">Add
                                        New</a>
                                </div>
                            </div>
                            <div class="card-body ">
                                <div class="table-scrollable">
                                    <table id="example1" class="display" style="width:100%;">
                                        ...
                                        @foreach($employment as $employment)
                                            <tr>
                                                <td><a href="{{route('ApplicantDetail',$employment->applicant_id)}}">{{$employment->Applicant_Employment->first_name}} {{$employment->Applicant_Employment->middel_name}} {{$employment->Applicant_Employment->surname}}</a></td>
                                                ...
                                                @endif
                                                <td class="text-left">
                                                    <form action="{{ route('Employment.edit', $employment->id)}}"
                                                          method="GET"
                                                    ...
                                                    <form action="{{ route('Employment.destroy', $employment->id)}}"
