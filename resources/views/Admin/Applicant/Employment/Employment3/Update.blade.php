    ...
    <div class="page-container" style="margin-top:-30px;">
        <div class="page-content-wrapper">
            <div class="page-content">
                        ...
                        <div class=" pull-right">
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li></i>&nbsp;<a class="parent-item"
                                                 href="{{route('Employment3.index')}}">Applicant Employment
                                        View</a>&nbsp;<i
                                            class="fa fa-angle-right"></i>
                                </li>
                ...
                <div class="card">
                    <form action="{{route('Employment3.update',$employment->id)}}" method="post"
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <p class="ah1" style="margin-top: 20px;">AuthorityPhone Number</p>
                                    <input type="text" class="form-control form"
                                           style="height:34px;width:80%;margin-top: -20px;"
