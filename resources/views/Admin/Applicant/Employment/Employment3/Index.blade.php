                        ...
                        <div class="card card-topline-aqua">
                            <div class="card-head">
                                ...
                                <div class="cards pull-right">
                                    <a href="{{route('Employment3.create')}}" class="btn btn-success fa fa-plus">Add
                                        New</a>
                                </div>
                            </div>
                            <div class="card-body ">
                                <div class="table-scrollable">
                                    <table id="example1" class="display" style="width:100%;">
                                        ...
                                        @foreach($employment as $employment)
                                            <tr>
                                                <td><a href="{{route('ApplicantDetail',$employment->applicant_id)}}">{{$employment->Applicant_Employment3->first_name}} {{$employment->Applicant_Employment3->middel_name}} {{$employment->Applicant_Employment3->surname}}</a></td>
                                                ...
                                                @endif
                                                <td class="text-left">
                                                    <form action="{{ route('Employment3.edit', $employment->id)}}"
                                                          method="GET"
                                                    ...
                                                    <form action="{{ route('Employment3.destroy', $employment->id)}}"
