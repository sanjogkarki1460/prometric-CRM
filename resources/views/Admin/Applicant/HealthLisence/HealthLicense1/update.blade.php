    ...
    <div class="page-container" style="margin-top:-30px;">
        <div class="page-content-wrapper">
            <div class="page-content">
                        ...
                        <div class=" pull-right">
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li></i>&nbsp;<a class="parent-item"
                                                 href="{{route('HealthLicense.index')}}">Applicant Health License
                                        View</a>&nbsp;<i
                                            class="fa fa-angle-right"></i>
                                </li>
                ...
                <div class="card">
                    <form action="{{route('HealthLicense.update',$healthlisence->id)}}" method="post"
                                    ...
                                    <select class="form-control form select2" id="applicant"
                                        ...
                                        @foreach($applicant as $applicant)
                                            <option @if($applicant->first_name==$app) selected
                                                    @endif value="{{$applicant->id}}">{{$applicant->first_name}} {{$applicant->middle_name}} {{$applicant->last_number}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control form"
                                           style="height:34px;width:80%;margin-top: -20px;" placeholder="Enter Lisence Number" name="license_number"
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control form"
                                           style="height:34px;width:80%;margin-top: -20px;" placeholder="Enter Lisence Attained" name="license_attained"
