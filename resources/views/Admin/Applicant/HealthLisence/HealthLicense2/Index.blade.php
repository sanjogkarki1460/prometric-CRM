                                    ...
                                    <table id="example1" class="display" style="width:100%;">
                                        ...
                                        @foreach($healthlicense  as $healthlicense  )
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('ApplicantDetail',$healthlicense->applicant_id)}}">{{$healthlicense->Applicant_Health2->first_name}} {{$healthlicense->Applicant_Health2->middle_name}} {{$healthlicense->Applicant_Health2->last_name}}</a>
                                                </td>
                                                ...
                                                @else
                                                    <td><a target="_blank "
                                                           href="{{asset('/upload/Health License/'.$healthlicense->license_copy)}}">Lisence
                                                            Copy</a></td>
                                                @endif
                                                @if(Auth::user()->role=='Admin')
                                                    <td class="text-left">
                                                        ...
                                                        <div class="mt-1">
                                                            <form action="{{ route('ApplicantDetail', $healthlicense->id)}}" style="display: inline-block">
